...
<section class="route-block section-mg">
    <div class="route-block__container container">
        <div class="route-block__wrapper grid grid-cols-1 lg:grid-cols-12 xl:grid-cols-10 gap-4 items-start">
            ...
            <div class="route-block__content w-full bg-beige-darker col-span-1 lg:col-span-6 xl:col-span-4 p-4 md:p-6 lg:p-8 h-full flex flex-col justify-between rounded-[8px]">
                <div class="top-content flex flex-col justify-between">
                    ...
                    <?php if ($bedrijfsnaam || $adres || $postcode || $plaats || $land) : ?>
                        ...
                        <div class="route-block-info flex flex-row gap-4 md:gap-5 text-grey-dark">
                            <div class="svg-wrapper">
            ...
            <?php if ( $google_maps ) : ?>
                <div class="route-block__map-wrapper bg-beige-darker w-full col-span-1 lg:col-span-6 xl:col-span-6 p-4 md:p-6 lg:p-8 rounded-[8px]">
