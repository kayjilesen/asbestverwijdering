...
<section class="text-image-block <?php echo esc_attr( $padding_class ); ?> <?php echo esc_attr( $bg_class ); ?>">
    <div class="text-image-block__container container">
        <div class="text-image-block__wrapper grid grid-cols-1 lg:grid-cols-12 xl:grid-cols-11 gap-12 lg:gap-24">
            ...
            <div class="text-image-block__content w-full col-span-1 lg:col-span-6 xl:col-span-6 order-1 <?php echo $alignment === 'left' ? 'lg:order-2' : 'lg:order-1'; ?> <?php echo esc_attr( $text_class ); ?>">
                ...
                <?php if ( $title ) : ?>
                    <h2 class="text-image-block__title font-title uppercase text-3xl md:text-4xl lg:text-5xl font-bold mb-6 <?php echo $mode === 'dark' ? 'text-white' : ''; ?>"><?php echo esc_html( $title ); ?></h2>
                <?php endif; ?>
            ...
            <!-- Image -->
            <?php if ( $image ) : ?>
                <div class="text-image-block__image-wrapper w-full col-span-1 lg:col-span-6 xl:col-span-5 order-2 <?php echo $alignment === 'left' ? 'lg:order-1' : 'lg:order-2'; ?>">
                    <div class="text-image-block__image-container overflow-hidden">
