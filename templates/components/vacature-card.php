...
<article class="vacatures-block__item group relative flex flex-col overflow-hidden <?php echo esc_attr($wrapper_class); ?>">
    <a href="<?php echo esc_url($vacature_link); ?>" class="vacatures-block__link block flex flex-col">
        <?php if ($image) : ?>
            <div class="vacatures-block__image-wrapper relative overflow-hidden">
                ...
                <!-- Gradient Overlay -->
                <div class="vacatures-block__gradient absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent z-10"></div>
                
                <!-- Content Overlay on Image -->
                <div class="vacatures-block__image-content absolute inset-0 z-20 flex flex-col items-start justify-end p-6 text-white">
                    ...
                    <?php if ($vacature_beschrijving) : ?>
                        <p class="vacatures-block__item-excerpt text-sm md:text-base leading-[1.4] text-[#dadada] line-clamp-3 mb-6">
                    ...
                    <div class="vacatures-block__details w-full">
                        <?php if ($location) : ?>
                            <div class="vacatures-block__detail-item flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                                <div class="vacatures-block__icon-wrapper flex-shrink-0">
                                    <svg class="vacatures-block__icon w-5 h-5 text-white" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p class="vacatures-block__detail-text font-bold text-base text-white">
                        ...
                        <?php if ($working_hours_text) : ?>
                            <div class="vacatures-block__detail-item flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                                <div class="vacatures-block__icon-wrapper flex-shrink-0">
                                    <svg class="vacatures-block__icon w-5 h-5 text-white" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
